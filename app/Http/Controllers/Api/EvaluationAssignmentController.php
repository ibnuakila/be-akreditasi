    ...
    public function uploadInstrument(Request $request)
    {
        ...
        if ($request->file()) {
            ...
            if (is_object($evaluation_assignment)) {
                ...
                $temp_inst_name = trim($spreadsheet->getActiveSheet()->getCell('A1' )->getCalculatedValue());
                ...
                return $this->sendError('Not found!', "Assignment not found! Make sure you are login as Assessor!");
            }
