...
class InstitutionController extends BaseController //implements ICrud 
{
    ...
    public function index() {
        ...
        return $this->sendResponse(new InstitutionResource($institutions), "Success", $institutions->count());
    }
    ...
    public function show($id) {
        ...
        return $this->sendResponse(new InstitutionResource($institution), 'Institution Available', $institution->count());
    }
    ...
    public function store(Request $request) {
        ...
        return $this->sendResponse(new InstitutionResource($institution), 'Institution Created', $institution->count);
    }
    ...
    public function update(Request $request, Institution $model) {
        ...
        return $this->sendResponse(new InstitutionResource($model), 'Institution Updated!', $model->count());
    }
}
